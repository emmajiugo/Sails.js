...
class UserSearchController extends Controller
{
    ...
    public function postSearch(Request $request)
    {
        ...
        $school = School::where('schoolname', 'LIKE', '%'.$request->schoolname.'%')->get();
        
        return redirect(route('user.search.school'))->with(['schools' => $school, 'sessiondetails' => $sessiondetails]);
    }
    ...
    public function postForInvoice(Request $request)
    {
        ...
        $school = School::find($invoicedetails->user_id);
