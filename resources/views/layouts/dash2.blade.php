...
<head>
  ...
  <!-- end linking -->
  <title>Schoolpay - User Dashboard</title>
  ...
  <div class="sidebar">
    ...
    <div id="list">
      <ul class="nav flex-column">
        ...
        <li class="nav-item"><a href="tabels.html" class="nav-link"><i class="fa fa-table"></i>Transactions</a></li>
        <li class="nav-item"><a href="#" class="nav-link"><i class="fa fa-money-bill-alt"></i>Savings Plan</a></li>
    ...
    <div class="head">
      ...
      <div class="top">
        ...
        <div class="right">
          ...
          <div class="dropdown">
            <button class="btn btn-info dropdown-toggle" id="userDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{ Auth::user()->fullname }}</button>
