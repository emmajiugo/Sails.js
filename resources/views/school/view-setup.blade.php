      ...
      <!-- start content here -->
        ...
        <div class="wrap card" id="support">
            ...
            <section class="app-content">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card-box" style="background-color:aliceblue; padding: 10px;">
                            ...
                            <form action="{{route('setup.search')}}" method='POST'>
                                ...
                                <div class="form-group">
                                    ...
                                    @else
                                        ...
                                        <small style="color:red"><a href="/school/setup-fees">Click Here</a> to set fees. Use the <b>Set Fees</b> button at the right hand of the page.</small>
                                    @endif
                                </div>
                                <div class="form-group">
                                ...
                                <div class="card-box card-front">
                                    <div class="row">
                                        <div class="col-lg-12" style="text-align:right">
                                            <a href="/school/advance-view" class="btn btn-sm btn-info">Advance View</a>
                            ...
                            <div class="back">
                                <div class="card-box card-back">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <button class="btn btn-sm btn-primary float-right" onclick="flipFunction()">Unflip</button>
                                        </div>
                                        <div class="col-lg-12">
                                            <br>
                                            @if(session('feesetup'))
                                                        ...
                                                        <div class="card-heading">
                                                            <h5 class="card-title">
                                                                <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">
                                                                    Setup <span class="sub-ico"><i class="fa fa-angle-down"></i></span> <!-- setup info for editting -->
                                                                </a>
                                                            </h5>
                                                            <small style="color:green">(click to expand)</small>
                                                        </div>
                                                        <div id="collapse1" class="card-collapse collapse in">
                                                            <div class="card-body">
                                                                <form action="{{route('setup.update', $feesetup->id)}}" method="POST">
                                                                    @csrf
                                                                    <input name='_method' value='PUT' hidden><!--to show its an update request-->
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    <h5 class="card-title">
                                                                        ...
                                                                        Fees Breakdown <span class="sub-ico"><i class="fa fa-angle-down"></i></span></a>
                                                                    </h5>
                                                                    <small style="color:green">(click to expand)</small>
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <button class="btn btn-sm btn-success float-right" data-toggle="modal" data-target="#addModal">Add Fees Breakdown</button>
                                                                </div>
                                                            </div>
                                                        </div>
